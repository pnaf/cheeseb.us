...
<body>
    <div id="content">
        ...
        <h6><input type="button" id="play" value="&nbsp;         play         &nbsp;" disabled="" onclick="document.getElementById('radio').play();top.document.title='&#x25b6; cheeseb.us radio';document.getElementById('play').value='&nbsp;         stop         &nbsp;';document.getElementById('play').onclick=function(){document.getElementById('radio').pause();window.location.href=window.location.href;};" />&nbsp;</h6>
        <form method="get" action="https://cheeseb.us/radio.m3u"><h6><input id="button" type="submit" value="listen in a media player" />&nbsp;</h6></form>
